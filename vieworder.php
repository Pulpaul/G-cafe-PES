...
$result = mysqli_query($con, "SELECT * FROM orders WHERE tid='$id'");
...
<html lang="en">
  <head>
    ...
    <title>JML Maps</title>
    <meta name="description" content="Palawan Reservation">
    <meta name="keywords" content="Palawan Reservation">

    
    <link href="https://fonts.googleapis.com/css?family=Work+Sans:300,400,700" rel="stylesheet">

    <link rel="stylesheet" href="userplaces/assets/css/bootstrap/bootstrap.css">
    <link rel="stylesheet" href="userplaces/assets/css/animate.css">
    <link rel="stylesheet" href="userplaces/assets/fonts/ionicons/css/ionicons.min.css">
    
    <link rel="stylesheet" href="userplaces/assets/css/owl.carousel.min.css">
    
    <link rel="stylesheet" href="userplaces/assets/fonts/flaticon/font/flaticon.css">

    <link rel="stylesheet" href="userplaces/assets/fonts/fontawesome/css/font-awesome.min.css">

    <link rel="stylesheet" href="userplaces/assets/css/select2.css">
    

    <link rel="stylesheet" href="userplaces/assets/css/helpers.css">
    <link rel="stylesheet" href="userplaces/assets/css/style.css">
...
<div class="container">
<div class="row">
<div class="col-sm-6" id="map" style="width:100%;height:560px;">
1
...
if(navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(position => {
        var uiCoords = position.coords.latitude + "," + position.coords.longitude;
  ...
  var router = platform.getRoutingService(),
    routeRequestParams = {
      ...
      waypoint0: uiCoords, // Brandenburg Gate
      waypoint1:'<?php echo $res["latitude"];?>,<?php echo $res["longitude"];?>'
    };
...
var platform = new H.service.Platform({
  app_id: '25NUG6nWwrl5SSiHdPu7',
  app_code: 'qa27tmWTKNV_N3L_VenRfg',
  useHTTPS: true
});
