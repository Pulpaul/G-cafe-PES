...
<html lang="en">
 ...
 >         <ul class="dropdown-menu">
            ...
            <li class="active"><a href="events.php">All Tournaments</a></li>
          </ul>
        </li>
        ...
        <div class=" ">
          ...
          while($row = mysqli_fetch_array($query)){
            ...
            <tr>
              ...
              <td>
                <a class="btn btn-success btn-sm" href="editEvent.php?id=<?php echo $row['id']; ?>" data-toggle="tooltip" title="Edit"><i class="glyphicon glyphicon-edit"></i></a> 
                <a class="btn btn-info btn-sm" href="viewEvents.php?id=<?php echo $row['id']; ?>" data-toggle="tooltip" title="View"> <i class="glyphicon glyphicon-eye-open"></i> </button> 
                <a class="btn btn-danger btn-sm" href="php/deleteEvent.php?id=<?php echo $row['id']; ?>"  data-toggle="tooltip" title="Delete"><i class="glyphicon glyphicon-trash"></i></a>
    ...
    <div id="addEvent" class="modal fade" data-keyboard="false" data-backdrop="static" data-show="true">
      <div class="modal-dialog">
        ...
        <div class="modal-body">
            ...
            <form method="POST" action="php/addEvents.php" onsubmit="return errors()">
            ...
            <label>Event Date</label> <span id="errorDates" class="text-danger"></span>
           <input type="date" name="eventdate" id="dates" class="form-control" required autofocus>
...
<!--/.Copyright-->
    ...
    <script type="text/javascript">  
        ...
        function errors(){
          var a = document.getElementById("dates").value; 

          if (a < "2019-03-23") {
            document.getElementById("errorDates").innerHTML=" Error!";
            return false;
          } 
