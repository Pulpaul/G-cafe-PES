      ...
      <div class=" ">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="active"><a href="marshall.php"> <span class="glyphicon glyphicon-user" aria-hidden="true"></span> Marshall accounts</a></li>
          </ul>
        </li>
        <li class="dropdown">
        ...
        <div class=" ">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <a style="cursor: pointer;" class="list-group-item" data-toggle="modal" data-target="#addnewMarhsallmodal"> <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Create Marshall Account</a>
                    </div>
                </div>
                <div class="col-md-9">
                    ...
                    <table id="marshallList" class="table table-striped table-hover">
                      <thead>
                        <tr>
                            <th>Marshall ID</th>
                            <th>Firstname</th>
          ...
          while($row=mysqli_fetch_array($query)){
            ...
            <tr>
              ...
              <td>
                <a class="btn btn-info btn-sm" href="editMarshall.php?id=<?php echo $row['marshall_id']; ?>"  data-toggle="tooltip" title="Edit"><i class="glyphicon glyphicon-edit"></i></a> 
                <a class="btn btn-danger btn-sm" href="php/deleteMarshall.php?id=<?php echo $row['marshall_id']; ?>"  data-toggle="tooltip" title="Delete"><i class="glyphicon glyphicon-trash"></i></a>
              </td>
            </tr>
            <?php } ?>
				                </tbody>
