...
include('php/connection.php');
  ...
  $query = mysqli_query($conn,"select * from `tbl_marshall` where id='$id'");
  ...
  <body>
    ...
    <section id="main">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="panel-heading main-color-bg">
                        <h3 class="panel-title"> Update Marshall List</h3>
                    </div>
                    <div class="panel-body">
                    <table class="table table-striped table-hover">
                        <tbody>
            <form method="post" action="php/updateMarshalls.php?id=<?php echo $id; ?>">
            <?php echo display_error(); ?>
            <label>First Name</label>
            <input type="text" name="firstname" value="<?php echo $row['firstname']; ?>"  onkeyup="lettersOnly(this)" class="form-control" required autofocus>

            <label>Middle Name</label>
            <input type="text" name="mname" value="<?php echo $row['mname']; ?>" onkeyup="lettersOnly(this)" class="form-control" required autofocus>

            <label>Final Name</label>
            <input type="text" name="lastname" value="<?php echo $row['lastname']; ?>" onkeyup="lettersOnly(this)" class="form-control" required autofocus>
            ...
            <input type="text" name="location" value="<?php echo $row['location']; ?>" class="form-control" required autofocus></input>

            <label>Contact Number</label>
            <input type="text" name="number" value="<?php echo $row['number']; ?>" class="form-control" required autofocus>
            <br>
          <input type="submit" name="submit" class="btn btn-success"><a href="marshalls.php" class="btn btn-danger" style="float: right;" >Back <i class="glyphicon glyphicon-arrow-left"></i></a>
          </div>
        </div>
    </div>
                        </tbody>
