...
include('php/connection.php');
  ...
  $query = mysqli_query($conn,"select * from `tbl_marshall` where marshall_id='$id'");
        ...
        <button class="btn btn-default borderless" type="button">Search</button>
                ...
                <div class="col-md-9">
                    ...
                    <table class="table table-striped table-hover">
                        <tbody>
            <form method="post" action="php/updateMarshall.php?id=<?php echo $id; ?>">
            ...
            <br>
          <input type="submit" name="submit" value="Update" class="btn btn-success"><a href="marshall.php" class="btn btn-danger" style="float: right;" >Back</a>
          </div>
        </div>
    </div>
                        </tbody>
